...
<?php
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
     ...
     $query .=" name,quantity,buy_price,sale_price,categorie_id,media_id,date,barcode_p";
     $query .=") VALUES (";
     $query .=" '{$p_name}', '{$p_qty}', '{$p_buy}', '{$p_sale}', '{$p_cat}', '{$media_id}', '{$date}', '{$p_bar}'";
     $query .=")";
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input  class="form-control" name="barcode_p" placeholder="Código de Barras">
                       </div>
                  </div>
               </div>
              </div>
