<?php
		class Conexion{
			...
			function Conexion(){
				...
				$this->baseDatos  ="almacen"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
			...
			function conectarse(){
				...
				if($enlace){
					echo "Reportes del almacén";	//si la conexion fue exitosa nos muestra este mensaje como prueba, despues lo puedes poner comentarios de nuevo: //
				}else{
